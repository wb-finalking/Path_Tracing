...
QT_MOC_LITERAL(1, 6, 12), // "statusChange"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 3) // "row"

    },
    "Scene\0statusChange\0\0row"
};
...
void Scene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->statusChange((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Scene::statusChange)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Scene::statusChange(int _t1)
{
